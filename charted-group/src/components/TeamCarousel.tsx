...
export default function TeamCarousel() {
  ...
  return (
    <div className="min-h-[600px] hidden">
      <div className="duration-500 w-full text-center mb-20">
        <h1
          className={`${ibmPlexSerif.className} leading-relaxed text-5xl lg:text-6xl font-thin`}>
          Our Team
        </h1>
      </div>
      <div className="block h-auto duration-500">
        <div className={`font-thin w-full select-none`}>
          ...
          <div className="overflow-hidden relative align-center" ref={emblaRef}>
